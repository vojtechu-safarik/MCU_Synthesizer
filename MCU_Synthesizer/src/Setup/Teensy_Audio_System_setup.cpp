...
void Teensy_Audio_setup() {
  ...
  ladder_Antialiasing.frequency(AA_filter_CornerFreq);
  ladder_Antialiasing.resonance(0);
  ...
  filterHP_1.frequency(default_HPF_Freq);
  filterHP_1.resonance(default_HPF_Res);
  filterHP_2.frequency(default_HPF_Freq);
  filterHP_2.resonance(default_HPF_Res);
  filterHP_3.frequency(default_HPF_Freq);
  filterHP_3.resonance(default_HPF_Res);
  filterSubHP.frequency(default_HPF_Freq);
  filterSubHP.resonance(default_HPF_Res);
  filterCloneHP_1.frequency(default_HPF_Freq);
  filterCloneHP_1.resonance(default_HPF_Res);
  filterCloneHP_2.frequency(default_HPF_Freq);
  filterCloneHP_2.resonance(default_HPF_Res);
  filterCloneHP_3.frequency(default_HPF_Freq);
  filterCloneHP_3.resonance(default_HPF_Res);
  filterDroneAHP_1.frequency(default_HPF_Freq);
  filterDroneAHP_1.resonance(default_HPF_Res);
  filterDroneAHP_2.frequency(default_HPF_Freq);
  filterDroneAHP_2.resonance(default_HPF_Res);
  filterDroneAHP_3.frequency(default_HPF_Freq);
  filterDroneAHP_3.resonance(default_HPF_Res);
  filterDroneAHP_4.frequency(default_HPF_Freq);
  filterDroneAHP_4.resonance(default_HPF_Res);
  filterDroneAHP_5.frequency(default_HPF_Freq);
  filterDroneAHP_5.resonance(default_HPF_Res);
  filterDroneBHP_1.frequency(default_HPF_Freq);
  filterDroneBHP_1.resonance(default_HPF_Res);
  filterDroneBHP_2.frequency(default_HPF_Freq);
  filterDroneBHP_2.resonance(default_HPF_Res);
  filterDroneBHP_3.frequency(default_HPF_Freq);
  filterDroneBHP_3.resonance(default_HPF_Res);
  filterDroneBHP_4.frequency(default_HPF_Freq);
  filterDroneBHP_4.resonance(default_HPF_Res);
  filterDroneBHP_5.frequency(default_HPF_Freq);
  filterDroneBHP_5.resonance(default_HPF_Res);

  filterNoiseHP_1.frequency(default_HPF_Freq);
  filterNoiseHP_1.resonance(default_HPF_Res); 
  filterNoiseDroneAHP.frequency(default_HPF_Freq);
  filterNoiseDroneAHP.resonance(default_HPF_Res); 
  filterNoiseDroneBHP.frequency(default_HPF_Freq);
  filterNoiseDroneBHP.resonance(default_HPF_Res); 
