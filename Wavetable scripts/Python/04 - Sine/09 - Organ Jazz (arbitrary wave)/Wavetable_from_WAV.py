...
wav_path = "Organ Jazz (sample).wav"

sample_count = 256        # počet vzorků ve výsledné wavetable
freq_override = 523.251   # např. 440.0 nebo None pro autodetekci
center_time = 0.1        # v s; None => střed nahrávky
window_duration = 0.05     # délka širšího úseku v sekundách, kolem center_time
out_header = "Organ_Jazz.h"
array_name = "Organ_Jazz_wavetable"
# =========================
# === End user params ====
# =========================
