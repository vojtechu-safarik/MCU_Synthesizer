...
wav_path = "Organ Groove (sample).wav"

sample_count = 256        # počet vzorků ve výsledné wavetable
freq_override = 103.826   # např. 440.0 nebo None pro autodetekci
center_time = 0.16        # v s; None => střed nahrávky
window_duration = 0.03     # délka širšího úseku v sekundách, kolem center_time
out_header = "Organ_Groove.h"
array_name = "Organ_Groove_wavetable"
# =========================
# === End user params ====
# =========================
