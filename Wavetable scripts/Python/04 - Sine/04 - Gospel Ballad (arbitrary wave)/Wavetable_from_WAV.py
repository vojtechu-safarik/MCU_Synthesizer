...
wav_path = "Gospel Ballad (sample).wav"

sample_count = 256        # počet vzorků ve výsledné wavetable
freq_override = 195.998   # např. 440.0 nebo None pro autodetekci
center_time = 0.09        # v s; None => střed nahrávky
window_duration = 0.04     # délka širšího úseku v sekundách, kolem center_time
out_header = "Gospel_Ballad.h"
array_name = "Gospel_Ballad_wavetable"
# =========================
# === End user params ====
# =========================
