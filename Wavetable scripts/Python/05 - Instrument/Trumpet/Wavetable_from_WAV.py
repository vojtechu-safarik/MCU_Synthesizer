...
wav_path = "Trumpet (sample).wav"

sample_count = 256        # počet vzorků ve výsledné wavetable
freq_override = 293.665   # např. 440.0 nebo None pro autodetekci
center_time = 0.15        # v s; None => střed nahrávky
window_duration = 0.01     # délka širšího úseku v sekundách, kolem center_time
out_header = "Trumpet.h"
array_name = "Trumpet_wavetable"
# =========================
# === End user params ====
# =========================
