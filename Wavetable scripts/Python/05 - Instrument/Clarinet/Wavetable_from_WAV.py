...
wav_path = "Clarinet (sample).wav"

sample_count = 256        # počet vzorků ve výsledné wavetable
freq_override = 184.997   # např. 440.0 nebo None pro autodetekci
center_time = 0.325        # v s; None => střed nahrávky
window_duration = 0.03     # délka širšího úseku v sekundách, kolem center_time
out_header = "Clarinet.h"
array_name = "Clarinet_wavetable"
# =========================
# === End user params ====
# =========================
